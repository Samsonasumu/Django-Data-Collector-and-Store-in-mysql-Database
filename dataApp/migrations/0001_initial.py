# Generated by Django 5.1 on 2024-12-17 19:54
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name_of_sport', models.CharField(default='', max_length=50, unique=True)),
                ('manager', models.CharField(default='', max_length=100)),
                ('manager_contact', models.CharField(default='', max_length=100)),
                ('manager_email', models.EmailField(default='abc@gmail.com', max_length=254)),
                ('coach', models.CharField(blank=True, max_length=100)),
                ('type', models.CharField(choices=[('M', 'Male'), ('F', 'Female'), ('MX', 'Mixed')], default='', max_length=20)),
                ('registration_number', models.CharField(default='', max_length=20, unique=True)),
