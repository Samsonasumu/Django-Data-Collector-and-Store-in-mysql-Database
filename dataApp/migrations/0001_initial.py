# Generated by Django 3.2.12 on 2024-09-17 20:57
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ward', models.CharField(choices=[('Shiru Ward', 'Shiru Ward'), ('Gisambai Ward', 'Gisambai Ward'), ('Shamakhokho Ward', 'Shamakhokho Ward'), ('Banja Ward', 'Banja Ward'), ('Muhudu Ward', 'Muhudu Ward'), ('Tambua Ward', 'Tambua Ward'), ('Jepkoyai Ward', 'Jepkoyai Ward'), ('Lyaduywa/Izava Ward', 'Lyaduywa/Izava Ward'), ('Sabatia West Ward', 'Sabatia West Ward'), ('Chavakali Ward', 'Chavakali Ward'), ('North Maragoli Ward', 'North Maragoli Ward'), ('Busali Ward', 'Busali Ward'), ('Wodanga Ward', 'Wodanga Ward'), ('Central Bunyore Ward', 'Central Bunyore Ward'), ('North East Bunyore Ward', 'North East Bunyore Ward'), ('West Bunyore Ward', 'West Bunyore Ward'), ('Luanda Township Ward', 'Luanda Township Ward'), ('Luanda South Ward', 'Luanda South Ward'), ('Mwibona Ward', 'Mwibona Ward'), ('Wemilabi Ward', 'Wemilabi Ward'), ('Emabungo Ward', 'Emabungo Ward'), ('Mungoma Ward', 'Mungoma Ward'), ('Maragoli Central Ward', 'Maragoli Central Ward'), ('Lugaga/Wamuluma Ward', 'Lugaga/Wamuluma Ward'), ('Maragoli South Ward', 'Maragoli South Ward')], max_length=255)),
                ...
                ('are_you_beneficiary_of_any_empowerment_fund', models.CharField(choices=[('youth enterprise development fund', 'Youth enterprise development fund'), ('uwezo fund', 'Uwezo fund'), ('ngaff', 'NGAAF')], max_length=200)),
